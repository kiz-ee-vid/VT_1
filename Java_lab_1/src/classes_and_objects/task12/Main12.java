...
public class Main12 {
    public static void main(String[] args) {
        ...
        ProgrammerBook programmerBook1 = new ProgrammerBook("Tittle3", "ProgrammerAuthor", 100, 3,"Russian", 2);
        ProgrammerBook programmerBook2 = new ProgrammerBook("Tittle4", "Author", 100, 4, "Belarusian", 2);
